...
//     }
    ...
    <h1 className='p-8 text-xl font-pat font-bold text-blue text-center md:text-sm '>Verify your account by entering the OTP sent to your registered email address.</h1>
